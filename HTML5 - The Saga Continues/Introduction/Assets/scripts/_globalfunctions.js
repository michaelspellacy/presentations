...
if (!!document.createElement('video').play) {
	...
	window.addEventListener('load',function() {
		...
		controller.innerHTML='<button id="playpause"><img src="images/player/play.png" width="15" height="15" alt="play"></button><output id="display">-:--:--</output><img src="images/player/audio.png" width="15" height="15" alt="volume" id="volumeicon"><input type="range" min="0" max="1" step="0.1" id="volume">';
		...
		video.addEventListener('play',function(e) {
			document.getElementById('playpause').innerHTML='<img src="images/player/pause.png" width="15" height="15" alt="pause">';
		}, true);

		/* when video actually pauses, update the play/pause button */	

		video.addEventListener('pause',function(e) {
			document.getElementById('playpause').innerHTML='<img src="images/player/play.png" width="15" height="15" alt="play">';
		}, true);
		...
		document.getElementById('volume').addEventListener('change',function(e) {
			...
			if (e.target.value==0) {
				...
				document.getElementById('volumeicon').src="images/player/audio-mute.png";
				...
				document.getElementById('volumeicon').src="images/player/audio.png";
